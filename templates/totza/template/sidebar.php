<div class="sidebar">
    ...
    <div class="widget">
        ...
        <h4>אודותינו <span class="glyphicon glyphicon-question-sign pull-left"></span></h4>
    ...
    <div class="widget">
        ...
        <h4 class="secondtitle">עדכונים אחרונים <span class="glyphicon glyphicon-th-list pull-left"></span></h4>
