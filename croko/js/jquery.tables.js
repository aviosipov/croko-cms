(function($){
    $.paginate = function(el, options) {
        ...
        base.init = function(){
            ...
            $('<li class="first"><a class="'+base.options.buttonClass+'" href="#">First</a></li>').click(function(){
            ...
            $('<li class="last"><a class="'+base.options.buttonClass+'" href="#">Last</a></li>').click(function(){
