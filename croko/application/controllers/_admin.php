...
class Admin extends CI_Controller {
	...
	function test() {
		...
		$oauthOptions = array(
		    ...
		    'version'              => '1.0',
		    'consumerKey'          => '763804792861.apps.googleusercontent.com',
		    'consumerSecret'       => 'J9j1tRBc62H2wZFm3x4Eax5f',
		    'signatureMethod'      => 'HMAC-SHA1',
		    'callbackUrl' 		   => 'http://getcontrol.co.il/admin/test',			
		...
		if (!isset($_SESSION['ACCESS_TOKEN_GOOGLE'])) { 
		    if (!empty($_GET)) { 
				...
				$this->User->set_google_access_token(serialize($token))  ;
