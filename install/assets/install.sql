...
--
-- Host: localhost
-- Generation Time: Aug 22, 2014 at 03:08 AM
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2275 ;
...
(1, 'New Croko CMS website!', 'admin', '', '', '', '', '', 1, '', '', '', '', '', 'he', '0', '', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'active', '', 'admin', '21232f297a57a5a743894a0e4a801fc3');
